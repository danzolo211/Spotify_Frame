...
// One clean transaction over a small region. Only cleanRects are driven through
// white; every other pixel in the region is preserved from the current canvas in
